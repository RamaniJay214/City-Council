...
<head>
  ...
  <title>Out of state parking and violations</title>
...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Out of state parking and violations</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          
          <li class="breadcrumb-item active">Out of state parking and violations</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card" style="width: 1100px;">
            <div class="card-body" >
            <img src="https://www.printablee.com/postpic/2014/12/free-printable-parking-tickets_420731.png" style="float: left; margin-top: 20px;" width="250px" height="170px">
           <h3 style="margin-top: 20px; padding-left: 30px;">Instructions:-</h3>
              <p>1.This request type is designed to report out of state vehicle consistently parking overnight. <br>
              2.Servicing Agency:-OSPV<br>
