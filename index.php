...
?>
  ...
  <main id="main" class="main">
    ...
    <img src="https://images.squarespace-cdn.com/content/v1/652045992dfc68640bcf024c/30c116ae-2cbd-481e-9cac-9276f900465b/Untitled+(1).jpeg" style="width:1100px; height:500px; display:block;">

    <section class="section dashboard" style="margin-top:10px;">
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Recent Requests <span></span></h5>
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Recent Activities of <span>| Indian Goverment </span></h5>

              <div class="activity">

                <div class="activity-item d-flex">
                  <div class="activite-label">Oct 2014</div>
                  <i class='bi bi-circle-fill activity-badge text-success align-self-start'></i>
                  <div class="activity-content">
                  Swachh Bharat Abhiyan (Clean India Campaign)<a href="#" class="fw-bold text-dark"></a>
                  </div>
                </div><!-- End activity item-->

                <div class="activity-item d-flex">
                  <div class="activite-label">Aug 2014</div>
                ...
                <div class="activity-item d-flex">
                  <div class="activite-label">Jun 2014</div>
                  <i class='bi bi-circle-fill activity-badge text-info align-self-start'></i>
                  <div class="activity-content">
                  Make in India <a href="#" class="fw-bold text-dark"></a>
                  </div>
                </div>

                <div class="activity-item d-flex">
                  <div class="activite-label">Sep 2018</div>
                ...
                <div class="activity-item d-flex">
                  <div class="activite-label">Jul 2015</div>
                ...
                <div class="activity-item d-flex">
                  <div class="activite-label">Recent</div>
