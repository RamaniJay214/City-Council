...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Lost|Found Claim</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          
          <li class="breadcrumb-item active">Lost|Found Claim</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card" style="width: 1100px;">
            <div class="card-body" >
            <img src="https://blog.library.gsu.edu/wp-content/uploads/2017/06/lost-items.jpg" style="float: left; margin-top: 20px;" width="250px" height="170px">
           <h3 style="margin-top: 20px; padding-left: 30px;">Instructions:-</h3>
              <p>1.Please use this service request type to request lost and found claim.Weather the thing is found anywhere or your thing is lost. But Property should be reflective.<br>
              2.Servicing Agency:-LFC<br>
              3.Service Resolution Estimate:- 5-10 Buisness days.<br>
