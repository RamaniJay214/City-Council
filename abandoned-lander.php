...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Abandoned Bicycle</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          
          <li class="breadcrumb-item active">Abandoned Bicycle</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card" style="width: 1100px;">
            <div class="card-body" >
            <img src="https://img00.deviantart.net/657a/i/2011/124/e/c/nostalgic_bike_by_ipawluk-d3f4uee.jpg" style="float: left; margin-top: 20px;" width="150px" height="150px">
           <h3 style="margin-top: 20px; padding-left: 30px;">Instructions:-</h3>
              <p>1.This Service Request is to be used for bicycles that are left on public space and which are Abandoned.<br>
              2.Servicing Agency:- DPW<br>
              3.Service Resolution Estimate:- 20 Buisness days.<br>
