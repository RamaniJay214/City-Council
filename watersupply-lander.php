...
<head>
  ...
  <title>Water-supply problem</title>
...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Water-supply problem</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          
          <li class="breadcrumb-item active">Water-supply problem</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card" style="width: 1100px;">
            <div class="card-body" >
            <img src="https://th.bing.com/th/id/R.c3dd6a79d5202762067cfd2557b4263b?rik=52EOSxZmdVnEtA&riu=http%3a%2f%2furbanupdate.in%2fwp-content%2fuploads%2f2019%2f04%2f2d5b8173-philippine-water-shortage.jpg&ehk=6mYeeA2IH8WTliZ2AIephgYHrAjjLVOcbYvPQj7WHy8%3d&risl=&pid=ImgRaw&r=0" style="float: left; margin-top: 20px;" width="250px" height="170px">
           <h3 style="margin-top: 20px; padding-left: 30px;">Instructions:-</h3>
              <p>1.Please use this service request type for water supply, water was not come yet.<br>
              2.Servicing Agency:-WS<br>
              3.Service Resolution Estimate:- 0-1 Buisness days.<br>
