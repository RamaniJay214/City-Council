...
<head>
  ...
  <title>Alley-Cleaning/Repair</title>
...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Alley Cleaning-Repair</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          
          <li class="breadcrumb-item active">Alley-cleaning repair</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card" style="width: 1100px;">
            <div class="card-body" >
            <img src="https://streetsla.lacity.org/sites/default/files/image_gallery/DSC_6844.JPG" style="float: left; margin-top: 20px;" width="200px" height="170px">
           <h3 style="margin-top: 20px; padding-left: 30px;">Instructions:-</h3>
              <p>1.Please use this service request type to request that public alleys be cleaned and for re-manufacture.<br>
              2.Servicing Agency:- ACR<br>
              3.Service Resolution Estimate:- 10-120 Buisness days.<br>
