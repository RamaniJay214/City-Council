...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Container Removal</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          
          <li class="breadcrumb-item active">Container Removal</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card" style="width: 1100px;">
            <div class="card-body" >
            <img src="https://1.bp.blogspot.com/-4iMNdHEPvo0/UpSfAk0cDrI/AAAAAAAAOJk/gqz_JW8tgPo/s1600/recycling_bins+image+from+WaPo.jpg" style="float: left; margin-top: 20px;" width="250px" height="170px">
           <h3 style="margin-top: 20px; padding-left: 30px;">Instructions:-</h3>
              <p>1.Please use this service request type to request removal of supercans,trash,container,recycling carts.<br>
              2.Servicing Agency:- CR<br>
              3.Service Resolution Estimate:- 10-15 Buisness days.<br>
