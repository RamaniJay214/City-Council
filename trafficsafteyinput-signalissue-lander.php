...
<head>
  ...
  <title>Traffic Saftey Input and Signal issue</title>
...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Traffic Saftey Input and Signal issue</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          
          <li class="breadcrumb-item active">Traffic Saftey Input and Signal issue</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card" style="width: 1100px;">
            <div class="card-body" >
            <img src="https://www.trafiksol.com/wp-content/themes/trafiksol/assets/images/post/image-26.jpg" style="float: left; margin-top: 20px;" width="250px" height="170px">
           <h3 style="margin-top: 20px; padding-left: 30px;">Instructions:-</h3>
              <p>1.Please use this service request type for traffic saftey input at public places or Traffic signal is'nt working.
              2.Servicing Agency:-RSR<br>
