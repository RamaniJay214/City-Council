...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Dead Animal collection</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          
          <li class="breadcrumb-item active">Dead Animal collection</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card" style="width: 1100px;">
            <div class="card-body" >
            <img src="https://th.bing.com/th/id/R.24e8fbfb8e86480e6606b7f35310bfc1?rik=AzAj%2fB5dIzVEeg&riu=http%3a%2f%2fwww.imageafter.com%2fimage.php%3fimage%3db8nature_extinct001.jpg%26dl%3d1&ehk=hVDlSQEPb2OxbG4vubi6gTH1xB7xcO2B9V7QPHpilto%3d&risl=&pid=ImgRaw&r=0" style="float: left; margin-top: 20px;" width="250px" height="170px">
           <h3 style="margin-top: 20px; padding-left: 30px;">Instructions:-</h3>
              <p>1.Please use this service request type to request the removal of dead animals on public property.<br>
              2.Servicing Agency:-DAC<br>
              3.Service Resolution Estimate:- 0-2 Buisness days.<br>
