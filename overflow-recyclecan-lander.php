...
<head>
  ...
  <title>Overflow Recycling Can</title>
...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Overflow Recycling Can</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          
          <li class="breadcrumb-item active">Overflow Recycling Can</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card" style="width: 1100px;">
            <div class="card-body" >
            <img src="https://www.photos-public-domain.com/wp-content/uploads/2011/03/garbage-cans-overflowing.jpg" style="float: left; margin-top: 20px;" width="250px" height="170px">
           <h3 style="margin-top: 20px; padding-left: 30px;">Instructions:-</h3>
              <p>1.Please use this service request type to request removal of overflow Recycling can in your street.<br>
              2.Servicing Agency:-ORC<br>
              3.Service Resolution Estimate:- 2-4 Buisness days.<br>
