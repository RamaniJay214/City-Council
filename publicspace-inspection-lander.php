...
<head>
  ...
  <title>Public Space Inspection and Litter removal</title>
...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Public Space Inspection and Litter removal</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          
          <li class="breadcrumb-item active">Public Space Inspection and Litter removal</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card" style="width: 1100px;">
            <div class="card-body" >
            <img src="https://cdn.prgloo.com/media/5b35fe30a5854653bae51fdbd8bc245c.jpg?width=706&height=1059" style="float: left; margin-top: 20px;" width="250px" height="170px">
           <h3 style="margin-top: 20px; padding-left: 30px;">Instructions:-</h3>
              <p>1.This is a request for public trash receptacles being removed from a residential area, major corridor, bus stop, public schools and hospital. <br>
              2.Servicing Agency:-PSILR<br>
              3.Service Resolution Estimate:- 0-5 Buisness days.<br>
