...
<head>
  ...
  <title>Roadway and Street repairs</title>
...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Roadway and Street repairs</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          
          <li class="breadcrumb-item active">Roadway and Street repairs</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card" style="width: 1100px;">
            <div class="card-body" >
            <img src="https://th.bing.com/th/id/OIP.ZIpnTta9DPROVDk9CoIL-AHaGl?w=597&h=531&rs=1&pid=ImgDetMain" style="float: left; margin-top: 20px;" width="250px" height="170px">
           <h3 style="margin-top: 20px; padding-left: 30px;">Instructions:-</h3>
              <p>1.Please use this service request type to investigate street/roadway surface issue.Provide specific location and describe the problem. <br>
              2.Servicing Agency:-RSR<br>
              3.Service Resolution Estimate:- 30-90 Buisness days.<br>
